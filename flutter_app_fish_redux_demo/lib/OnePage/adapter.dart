...
import 'package:flutterappfishreduxdemo/OneCom/state.dart';
import 'package:flutterappfishreduxdemo/ThreeCom/component.dart';
import 'package:flutterappfishreduxdemo/ThreeCom/state.dart';
import 'package:flutterappfishreduxdemo/TwoCom/component.dart';
import 'package:flutterappfishreduxdemo/TwoCom/state.dart';
import 'state.dart';
...
class _OnePageConnector extends ConnOp<OnePageState, List<ItemBean>> {
  ...
  List<ItemBean> get(OnePageState state) {
    ...
    items.addAll(item3List.map((str)=>ItemBean("item3", ThreeComState(someString: str))).toList());
