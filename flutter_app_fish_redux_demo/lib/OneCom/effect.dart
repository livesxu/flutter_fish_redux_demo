...
import 'package:flutterappfishreduxdemo/OnePage/action.dart';
import 'package:flutterappfishreduxdemo/TwoPage/page.dart';
import 'action.dart';
import 'state.dart';
...
//    ctx.dispatch(OnePageActionCreator.onAction());
    Navigator.of(ctx.context).push(MaterialPageRoute(builder: (_)=> TwoPagePage().buildPage({"passString":"passString","btnTitle":"返回"})));
  }
}
